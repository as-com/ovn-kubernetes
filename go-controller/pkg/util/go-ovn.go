...
var OVNNBDBClient *OVNClient
var OVNSBDBClient *OVNClient

func InitOVNDBClients() error {
	var err error

	if OVNNBDBClient == nil {
		OVNNBDBClient = &OVNClient{}
	}

	if OVNSBDBClient == nil {
		OVNSBDBClient = &OVNClient{}
	}

	switch config.OvnNorth.Scheme {
	case config.OvnDBSchemeSSL:
		OVNNBDBClient.client, err = initGoOvnSslClient(config.OvnNorth.Cert,
			config.OvnNorth.PrivKey, config.OvnNorth.CACert,
			config.OvnNorth.GetURL(), goovn.DBNB)
	case config.OvnDBSchemeTCP:
		OVNNBDBClient.client, err = initGoOvnTcpClient(config.OvnNorth.GetURL(), goovn.DBNB)
	case config.OvnDBSchemeUnix:
		OVNNBDBClient.client, err = initGoOvnUnixClient(config.OvnNorth.GetURL(), goovn.DBNB)
	default:
	...
	case config.OvnDBSchemeSSL:
		OVNSBDBClient.client, err = initGoOvnSslClient(config.OvnSouth.Cert,
			config.OvnSouth.PrivKey, config.OvnSouth.CACert,
			config.OvnSouth.GetURL(), goovn.DBSB)
	case config.OvnDBSchemeTCP:
		OVNSBDBClient.client, err = initGoOvnTcpClient(config.OvnSouth.GetURL(), goovn.DBSB)
	case config.OvnDBSchemeUnix:
		OVNSBDBClient.client, err = initGoOvnUnixClient(config.OvnSouth.GetURL(), goovn.DBSB)
	default:
...
func disconnectCb() {
	klog.Infof("Received disconnect callback for the clients")
	defer reconnect()
}
...
func reconnect() {
	...
	go func() {
		for range reconnectTicker.C {
			klog.Infof("Reconnecting OVN client")
			if err := InitOVNDBClients(); err != nil {
				continue
			}
			return
		}
...
func (ovnclient *OVNClient) LSAdd(ls string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LSDel(ls string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LSExtIdsAdd(ls string, external_ids map[string]string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LSExtIdsDel(ls string, external_ids map[string]string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LinkSwitchToRouter(lsw, lsp, lr, lrp, lrpMac string, networks []string, externalIds map[string]string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LSPAdd(ls string, lsp string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LSPDel(lsp string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LSPSetAddress(lsp string, addresses ...string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LSPSetPortSecurity(lsp string, security ...string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
// Add LB to LSW
func (ovnclient *OVNClient) LSLBAdd(ls string, lb string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
// Delete LB from LSW
func (ovnclient *OVNClient) LSLBDel(ls string, lb string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
// Add ACL
func (ovnclient *OVNClient) ACLAdd(ls, direct, match, action string, priority int, external_ids map[string]string, logflag bool, meter string, severity string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
// Delete acl
func (ovnclient *OVNClient) ACLDel(ls, direct, match string, priority int, external_ids map[string]string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
// Update address set
func (ovnclient *OVNClient) ASUpdate(name string, addrs []string, external_ids map[string]string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
// Add addressset
func (ovnclient *OVNClient) ASAdd(name string, addrs []string, external_ids map[string]string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
// Delete addressset
func (ovnclient *OVNClient) ASDel(name string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LRAdd(name string, external_ids map[string]string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LRDel(name string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LRPAdd(lr string, lrp string, mac string, network []string, peer string, external_ids map[string]string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LRPDel(lr string, lrp string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LRSRAdd(lr string, ip_prefix string, nexthop string, output_port []string, policy []string, external_ids map[string]string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LRSRDel(lr string, ip_prefix string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
	return ovnclient.client.LRSRDel(lr, ip_prefix)
}
...
// Add LB to LR
func (ovnclient *OVNClient) LRLBAdd(lr string, lb string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
// Delete LB from LR
func (ovnclient *OVNClient) LRLBDel(lr string, lb string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
// Add LB
func (ovnclient *OVNClient) LBAdd(name string, vipPort string, protocol string, addrs []string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LBDel(name string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
// Update existing LB
func (ovnclient *OVNClient) LBUpdate(name string, vipPort string, protocol string, addrs []string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LSPSetDHCPv4Options(lsp string, options string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LSPSetDHCPv6Options(lsp string, options string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
// Set options in LSP
func (ovnclient *OVNClient) LSPSetOptions(lsp string, options map[string]string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LSPSetDynamicAddresses(lsp string, address string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LSPSetExternalIds(lsp string, external_ids map[string]string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) DHCPOptionsAdd(cidr string, options map[string]string, external_ids map[string]string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) DHCPOptionsSet(uuid string, options map[string]string, external_ids map[string]string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) DHCPOptionsDel(uuid string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
// Add qos rule
func (ovnclient *OVNClient) QoSAdd(ls string, direction string, priority int, match string, action map[string]int, bandwidth map[string]int, external_ids map[string]string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) QoSDel(ls string, direction string, priority int, match string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LRNATAdd(lr string, ntype string, externalIp string, logicalIp string, external_ids map[string]string, logicalPortAndExternalMac ...string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) LRNATDel(lr string, ntype string, ip ...string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) MeterAdd(name, action string, rate int, unit string, external_ids map[string]string, burst int) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
// Deletes meters
func (ovnclient *OVNClient) MeterDel(name ...string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) Execute(cmds ...*goovn.OvnCommand) error {
	if ovnclient.client == nil {
		return syscall.ENOTCONN
	}
	return ovnclient.client.Execute(cmds...)
}
...
func (ovnclient *OVNClient) ChassisDel(chName string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) NBGlobalSetOptions(options map[string]string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
...
func (ovnclient *OVNClient) SBGlobalSetOptions(options map[string]string) (*goovn.OvnCommand, error) {
	if ovnclient.client == nil {
		return nil, syscall.ENOTCONN
	}
